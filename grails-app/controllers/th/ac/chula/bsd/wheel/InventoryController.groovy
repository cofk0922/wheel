...
class InventoryController {
    ...
    def save(Inventory inventoryInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'inventoryInstance.label', default: 'Inventory'), inventoryInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'inventoryInstance.label', default: 'Inventory'), params.id])
                redirect action: "index", method: "GET"
            }
