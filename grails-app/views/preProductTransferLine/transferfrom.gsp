...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'productTransferFromLine.label', default: 'ProductTransferFromLine')}" />
	...
	<body>
		...
		<div id="list-productTransferLine" class="content scaffold-list" role="main">
			...
			<span>
				<g:link action="transferfrom" params="[isViewNew:true]"><g:message code="preProductTransferLine.submenu.transferFrom.statusNew.label" /></g:link>
				|
				<g:link action="transferfrom" params="[isViewTransfered:true]"><g:message code="preProductTransferLine.submenu.transferFrom.statusTransfered.label"/></g:link>
				|
				<g:link action="transferfrom" params="[isViewReceived:true]"><g:message code="preProductTransferLine.submenu.transferFrom.statusReceived.label" /></g:link>
			</span>
			<table>
			<thead>
					<tr>
				...
				<g:form controller="preProductTransferLine" action="transferToOther" params="${[productTransferLineInstanceID:productTransferLineInstance.id] }" method="POST" >
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<g:if test="${params.isViewNew}">
							<td><g:submitButton name="transferToOther" value="${message(code: 'productTransferFromLine.transfer.label') }" /></td>
						</g:if>
