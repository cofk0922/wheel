		...
		<div id="show-nut" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:nutInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="list" action="index" controller="productVendorTransfer" params="${[prodID:nutInstance.id, prodType:nutInstance.productType]}"><g:message code="nut.productVendorTransfers.label" /></g:link>
